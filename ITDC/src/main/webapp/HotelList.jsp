...
<body style = "background: url(https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSnvf8wU9bC7dfuXUUTb0IaqZpshICUtLz59A&usqp=CAU.jpg)">
       ...
       <center>
  <h2 style="background-color:aqua;"style="font-size:30px;">LIST OF HOTELS </h2>
  <table border="1">
      <thead>
         <tr>
             <th>HotelId</th>
