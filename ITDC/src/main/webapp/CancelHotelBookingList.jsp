...
<body style = "background: url(https://images.unsplash.com/photo-1501769214405-5e5ee5125a02?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60.jpg)"> 
       ...
       <center>
  <h2 style="background-color:Orange;"style="font-size:30px;"> CANCEL BOOKING HOTELS LIST</h2>
  <table border="1">
      <thead>
         <tr>
             <th>UserPhNo</th>
