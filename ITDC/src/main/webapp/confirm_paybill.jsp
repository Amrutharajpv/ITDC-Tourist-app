...
<body style = "background: url(https://images.unsplash.com/photo-1510877073473-6d4545e9c2af?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60.jpg)">
        ...
        <form action="confirm_paybill">
          ...
          <p style="color:blue">Your Phone no</p>  
           ...
           <h3>${h.getHotelPhNo()}</h3>
            ...
            <p style="color:blue">Total Rent</p>
